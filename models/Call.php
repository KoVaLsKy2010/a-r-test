...
class Call extends ActiveRecord
{
    ...
    /**
     * @var int Длительность. Чего? Непонятно по коду, приходится догадываться.
     * Возможно длительность разговора или сколько времени прошло с момента звонка.
     * Имя свойства, на мой взгляд, выбрано неудачно.
     * Почему как свойство, а не константа? Нигде не меняется в коде.
     */
    public $duration = 720;
